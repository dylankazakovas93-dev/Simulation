...
class _AccountMachine:
    ...
    def _maybe_payout(self, ts: pd.Timestamp) -> None:
        ...
        self.balance -= gross
        # withdrawals move the trailing floor down with the balance (no self-breach)
        self.peak -= gross
...
def run_prop_account_path(
    ...
    *,
    ...
    time_to_first_payout_days: float | None = None
    if machine.first_payout_timestamp is not None and stream_start is not None:
        time_to_first_payout_days = (
            machine.first_payout_timestamp - stream_start
    ...
    summary: dict[str, Any] = {
        ...
        "time_to_first_payout_days": time_to_first_payout_days,
